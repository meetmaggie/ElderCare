              ...
              <div className="relative w-80 h-80 mx-auto">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <button
                    ...
                    className="bg-white rounded-full px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-3 border border-trust-100 hover:scale-105"
                  >
                    {/* Play icon */}
                    ...
                    {/* Button text */}
                    <span className="font-semibold text-trust-900 text-lg">Meet Sarah</span>
                  </button>
                </div>
              </div>
